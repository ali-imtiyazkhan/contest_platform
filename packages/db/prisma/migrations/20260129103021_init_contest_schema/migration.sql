...
-- CreateIndex
CREATE UNIQUE INDEX "ContestSubmission_contestToChallengeMappingId_userId_key" ON "public"."ContestSubmission"("contestToChallengeMappingId", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "Leaderboard_contestId_rank_key" ON "public"."Leaderboard"("contestId", "rank");

-- AddForeignKey
ALTER TABLE "public"."ContestToChallengeMapping" ADD CONSTRAINT "ContestToChallengeMapping_contestId_fkey" FOREIGN KEY ("contestId") REFERENCES "public"."Contest"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."ContestToChallengeMapping" ADD CONSTRAINT "ContestToChallengeMapping_challengeId_fkey" FOREIGN KEY ("challengeId") REFERENCES "public"."Challenge"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."ContestSubmission" ADD CONSTRAINT "ContestSubmission_contestToChallengeMappingId_fkey" FOREIGN KEY ("contestToChallengeMappingId") REFERENCES "public"."ContestToChallengeMapping"("id") ON DELETE CASCADE ON UPDATE CASCADE;
