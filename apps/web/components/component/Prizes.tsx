      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {prizes.map((prize) => (
          ...
          >
            ...
            <p
              className={`text-[0.7rem] tracking-[2px] uppercase mb-4 ${prize.featured ? "text-black/50" : "text-muted"
                }`}
              style={{ fontFamily: "'DM Mono', monospace" }}
            >
              {prize.position}
            ...
            <div
              className={`text-[4rem] leading-none mb-3 ${prize.featured ? "text-black" : "text-cream"
                }`}
            ...
            <p
              className={`font-bold text-base mb-2.5 ${prize.featured ? "text-black" : "text-cream"
                }`}
            >
              {prize.title}
            </p>
            <p
              className={`text-[0.82rem] leading-[1.6] ${prize.featured ? "text-black/60" : "text-muted"
                }`}
            >
              {prize.description}
            </p>
